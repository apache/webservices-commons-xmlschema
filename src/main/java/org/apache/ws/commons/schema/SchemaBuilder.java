...
public class SchemaBuilder {
     ...
     * situationsCAUTION: XmlSchema objects are not likely to be thread-safe. This cache should only be used,
    ...
    XmlSchema handleXmlSchemaElement(Element schemaEl, String systemId) {
        ...
        schema.setElementFormDefault(this.getFormDefault(schemaEl, "elementFormDefault"));
        schema.setAttributeFormDefault(this.getFormDefault(schemaEl, "attributeFormDefault"));
        ...
        /***********
         * for ( each childElement) if( simpleTypeElement) handleSimpleType else if( complexType)
         * handleComplexType else if( element) handleElement else if( include) handleInclude else if( import)
         * handleImport else if (group) handleGroup else if (attributeGroup) handleattributeGroup else if(
         * attribute) handleattribute else if (redefine) handleRedefine else if(notation) handleNotation else
        ...
        for (; el != null; el = XDOMUtil.getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
            ...
            if (el.getLocalName().equals("simpleType")) {
                ...
                XmlSchemaImport schemaImport = handleImport(schema, el, schemaEl);
                ...
                XmlSchemaAttribute attr = handleAttribute(schema, el, schemaEl, true); // pass true to
                                                                                       // indicate that it is
                                                                                       // a top level child
                ...
                schema.notations.collection.put(new QName(schema.getTargetNamespace(), notation.name),
                                                notation);
    ...
    private XmlSchemaRedefine handleRedefine(XmlSchema schema, Element redefineEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(redefineEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
    ...
    XmlSchemaSimpleType handleSimpleType(XmlSchema schema, Element simpleEl, Element schemaEl) {
        ...
        if ((restrictionEl = XDOMUtil.getFirstChildElementNS(simpleEl, XmlSchema.SCHEMA_NS, "restriction")) != null) {
             ...
             * restricion has a SimpleType Element as child) get that element and do a handleSimpleType; get
            ...
            for (Element el = XDOMUtil.getFirstChildElementNS(restrictionEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
                .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
        ...
        } else if ((listEl = XDOMUtil.getFirstChildElementNS(simpleEl, XmlSchema.SCHEMA_NS, "list")) != null) {
            ...
            } else if ((inlineListType = XDOMUtil.getFirstChildElementNS(listEl, XmlSchema.SCHEMA_NS,
                                                                         "simpleType")) != null) {

                list.itemType = handleSimpleType(schema, inlineListType, schemaEl);
            }

            if ((listAnnotationEl = XDOMUtil
                .getFirstChildElementNS(listEl, XmlSchema.SCHEMA_NS, "annotation")) != null) {
        ...
        } else if ((unionEl = XDOMUtil.getFirstChildElementNS(simpleEl, XmlSchema.SCHEMA_NS, "union")) != null) {
    ...
    XmlSchemaComplexType handleComplexType(XmlSchema schema, Element complexEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(complexEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaSimpleContent handleSimpleContent(XmlSchema schema, Element simpleEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(simpleEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaSimpleContentExtension handleSimpleContentExtension(XmlSchema schema, Element extEl,
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(extEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaSequence handleSequence(XmlSchema schema, Element sequenceEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(sequenceEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaChoice handleChoice(XmlSchema schema, Element choiceEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(choiceEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaAll handleAll(XmlSchema schema, Element allEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(allEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaGroup handleGroup(XmlSchema schema, Element groupEl, Element schemaEl) {
        ...
        for (Element el = XDOMUtil.getFirstChildElementNS(groupEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
            .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    private XmlSchemaAttribute handleAttribute(XmlSchema schema, Element attrEl, Element schemaEl,
        ...
        for (int i = 0; i < attrNodes.getLength(); i++) {
            ...
            if (!attName.equals("name") && !attName.equals("type") && !attName.equals("default")
                && !attName.equals("fixed") && !attName.equals("form") && !attName.equals("id")
     ...
     * restriciton has an inline simpleType ) handleSimpleType add facets if any to the restriction
     */
    ...
    XmlSchemaElement handleElement(XmlSchema schema, Element el, Element schemaEl, boolean isGlobal) {
        ...
        if ((simpleTypeEl = XDOMUtil.getFirstChildElementNS(el, XmlSchema.SCHEMA_NS, "simpleType")) != null) {
        ...
        } else if ((complexTypeEl = XDOMUtil.getFirstChildElementNS(el, XmlSchema.SCHEMA_NS, "complexType")) != null) {
        ...
        if (el.hasAttribute("abstract")) {
            element.isAbstract = Boolean.valueOf(el.getAttribute("abstract")).booleanValue();
        }
    ...
    private XmlSchemaIdentityConstraint handleConstraint(Element constraintEl, String type) {
        ...
        try {
            XmlSchemaIdentityConstraint constraint = (XmlSchemaIdentityConstraint)Class.forName(
            ...
            for (Element el = XDOMUtil.getFirstChildElementNS(constraintEl, XmlSchema.SCHEMA_NS); el != null; el = XDOMUtil
                .getNextSiblingElementNS(el, XmlSchema.SCHEMA_NS)) {
    ...
    XmlSchemaAnnotation handleAnnotation(Element annotEl) {
        ...
        for (Element appinfo = XDOMUtil.getFirstChildElementNS(annotEl, XmlSchema.SCHEMA_NS, "appinfo"); appinfo != null; appinfo = XDOMUtil
            .getNextSiblingElementNS(appinfo, XmlSchema.SCHEMA_NS, "appinfo")) {
        ...
        for (Element documentation = XDOMUtil.getFirstChildElementNS(annotEl, XmlSchema.SCHEMA_NS,
                                                                     "documentation"); documentation != null; documentation = XDOMUtil
