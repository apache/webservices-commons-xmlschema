...
public final class TestW3CSchemaTestSet extends TestSuite {
    ...
    /**
     * Returns a suite of TestRoundTripXSD test case instances. One for each of the tests described in the
     * testSetFile
     * 
    ...
    /**
     * Returns a list of SchemaTest objects created from the .testSet xml file passed in to the testSet
     * parameter
     * 
        ...
        for (int i = 0; i < testGroups.getLength(); i++) {
            ...
            if (schemaTestElem != null) {
                try {
                    ...
                    SchemaTest schemaTest = new SchemaTest(schemaTestElem);
                    if (schemaTest.schemaDocumentLink != null) {
